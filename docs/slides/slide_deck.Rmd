...
<small>Back to [Why is tidy data important?](#why-tidy) slide<small>
...
What `ggplot2` code is needed to produce this plot? The `simple_ex` data frame is printed for support. This time, you can use your hand-written notes.
