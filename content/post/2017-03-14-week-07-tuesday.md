...
### To do for next time
- Review the [Problem Set 6 Discussion](https://ismayc.github.io/soc301_s2017/problem-sets/ps-key/index.html#ps6-key) and identify at least one question you have about what I have written compared to what you wrote as a response.
- Finish your Group Project by writing your final analysis ALL inside the `group_project.Rmd` file
  - I recommend that you do this on only one machine so that you don't overwrite someone else's work using Google Drive.  Google Drive is great for backing things up but not for everyone working on the same file at the same time.
